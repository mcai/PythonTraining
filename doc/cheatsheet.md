Scientific Python Cheatsheet Python之科学计算宝典
============================
<!-- markdown-toc start - Don't forget to edit this section according to your modifications -->
**目录**

- [Python之科学计算宝典](#scientific-python-cheatsheet)
    - [Python基础](#pure-python)
        - [类型](#types)
        - [列表](#lists)
        - [字典](#dictionaries)
        - [集合](#sets)
